...
<?php
   ...
   if(isset($_FILES['file'])){
      ...
      if(empty($errors)==true){
         ...
         $sql = "INSERT INTO file Values(null,'$file_name',2,3,null)";
...
<div id="main">
	...
	<p id="subtitle">Computer Technology</p>
	<div id="slider">
	...
	<div id="container"style="height:auto;width:500px;min-height:300px;">
   		<p id="recentTitle" style="width: 96%">Topic Outline</p>
            ...
            <?php
               ...
               $q = "SELECT filename FROM file WHERE course=2 AND subject=3 ORDER BY datetime desc";
               if ($result = $db->query($q)) {
				...
				&target=computing-subjects/computer-technology.php">DELETE</a>';
                           }
