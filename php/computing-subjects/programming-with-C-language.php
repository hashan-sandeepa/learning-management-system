...
<?php
   ...
   if(isset($_FILES['file'])){
      ...
      if(empty($errors)==true){
         ...
         $sql = "INSERT INTO file Values(null,'$file_name',2,9,null)";
...
<div id="main">
	...
	<p id="subtitle">Programming with C Language</p>
	<div id="slider">
	...
	<div id="container"style="height:auto;width:500px;min-height:300px;">
   		<p id="recentTitle" style="width: 96%">Topic Outline</p>
            ...
            <?php
               ...
               $q = "SELECT filename FROM file WHERE course=2 AND subject=9 ORDER BY datetime desc";
               if ($result = $db->query($q)) {
				...
				&target=computing-subjects/programming-with-C-language.php">DELETE</a>';
                           }
