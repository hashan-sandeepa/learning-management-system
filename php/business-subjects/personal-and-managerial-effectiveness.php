...
<?php
   ...
   if(isset($_FILES['file'])){
      ...
      if(empty($errors)==true){
         ...
         $sql = "INSERT INTO file Values(null,'$file_name',1,3,null)";
...
<div id="main">
	...
	<p id="subtitle">Personal and Managerial Effectiveness</p>
	<div id="slider">
	...
	<div id="container"style="height:auto;width:500px;min-height:300px;">
   		<p id="recentTitle" style="width: 96%">Topic Outline</p>
            ...
            <?php
               ...
               $q = "SELECT filename FROM file WHERE course=1 AND subject=3 ORDER BY datetime desc";
               if ($result = $db->query($q)) {
				...
				&target=business-subjects/personal-and-managerial-effectiveness.php">DELETE</a>';
                           }
