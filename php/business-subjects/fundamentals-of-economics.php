...
<?php
   ...
   if(isset($_FILES['file'])){
      ...
      if(empty($errors)==true){
         ...
         $sql = "INSERT INTO file Values(null,'$file_name',1,5,null)";
...
<div id="main">
	...
	<p id="subtitle">Fundamentals of Economics</p>
	<div id="slider">
	...
	<div id="container"style="height:auto;width:500px;min-height:300px;">
   		<p id="recentTitle" style="width: 96%">Topic Outline</p>
            ...
            <?php
               ...
               $q = "SELECT filename FROM file WHERE course=1 AND subject=5 ORDER BY datetime desc";
               if ($result = $db->query($q)) {
				...
				&target=business-subjects/fundamentals-of-economics.php">DELETE</a>';
                           }
